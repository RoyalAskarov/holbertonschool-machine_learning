...
def cofactor(matrix):
    ...
    # The output shows 'cofactor(mat5)' where mat5=[] raises
    ...
    # The cofactor of a 1x1 matrix is implicitly [[1]] in this context
    # matching the sample output provided in the image.
    if n == 1:
        return [[1]]
    ...
    for r in range(n):
        ...
        for c in range(n):
            ...
            # If (r + c) is even, sign is positive (+1)
            # If (r + c) is odd, sign is negative (-1)
            sign = (-1) ** (r + c)
